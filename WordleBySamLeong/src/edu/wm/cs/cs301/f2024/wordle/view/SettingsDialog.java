...
public class SettingsDialog extends JDialog {
	...
	public SettingsDialog(WordleFrame view) {
		super(view.getFrame(), AppStrings.SETTINGS___, true);
	...
	private JPanel createMainPanel() {
		...
		URL url = InstructionsDialog.class.getResource(AppStrings.RESOURCES_SETTINGS_HTM);
